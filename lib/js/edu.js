...
// testDelegate();  // just for testing
  ...
  function initTopVariables() {
    ...
    q._("dialogmask").style.bottom = q._("bottomdiv").offsetHeight + "px";
  }
...
// }
  ...
  function showCreatorLoginBox() {
    ...
    // show the box
    common.showDialog2("creatorloginbox");
  ...
  q.delegate("creatorloginbox", "click", "button", function clickOnCreatorloginboxButton(e) {
    ...
    if (butt === "Next") {
      ...
      if (pwStringCheck(ob)) {
        common.hideDialog2("creatorloginbox");
        showGetQnaKeyBox();
      } else {
  ...
  function showGetQnaKeyBox() {
    ...
    common.showDialog2("getqnakeybox");
  ...
  q.qs("#getqnakeybox button").addEventListener("click", function clickOnGetqnakeyboxButton(e) {
    ...
    if (butt === "Calculate key") {
      ...
      common.hideDialog2("getqnakeybox");
    }
  }
  );
  ...
  function OpenFile() {
    ...
    common.showDialog2("myExplorer");
  }

  function checkopenfile(butt, fname = "") {
    common.hideDialog2('myExplorer');
  ...
  function Categories() {
    ...
    if (getcatarray(ob)) {
      ...
      common.showDialog2("catlist_container");
      dirty = false;
    } else {
  ...
  q.delegate("catlist_container", "click", "button", function clickOnButtonInCategoriesList(e) {
    ...
    if (butt === "Select all" || butt === "Select none") {
      ...
      common.hideDialog2("catlist_container");
      if (butt === "Apply") {
        if (!dirty) return;
  ...
  function Timeallowed() {
    ...
    orgta = realta;
    common.showDialog2("gettimeallowed");
  }
  ...
  q.delegate("gettimeallowed", "click", "button", function (e) {
    ...
    if (butt == "Reset") {
      ...
      common.hideDialog2("gettimeallowed");
      if (butt === "Apply") {
        realta = orgta;
      }
    }
...
q._('wrappermask').classList.remove('nodisplay');
    // common.putMask("wrappermask", "wrapper");
  ...
  function Audiovolume() {
    ...
    common.showDialog2("getaudiovolume");
  }
  ...
  q.delegate("getaudiovolume", "click", "button", function (e) {
    ...
    if (butt == "Reset") {
      ...
      common.hideDialog2("getaudiovolume");
    }
  });
