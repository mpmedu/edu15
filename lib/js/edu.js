...
xx.module("edu", function (apod) {
  let vars = xx.vars;
  let q = xx.q; // q must come before edu else this won't work
  ...
  function readyFunction() {
    ...
    common.makemenu();
    myExpl.addEventHandlers(xx.edu);
  ...
  function init() {
    return new Promise((resolve, reject) => {
      Promise.all([xx.myExpl.showTheFolders(), fixCompid()]).then(resolve);
      initTopVariables();
      initAudio();
  ...
  function fixCompid() {
    return new Promise((resolve, reject) => {
      if (typeof localStorage === "undefined") {
        ...
        common
          .doFetch("ft_temp.php", "setCompID", null, {}, "", function (json) {
  ...
  function checkopenfile(butt, fname = "") {
    // q._("fn_input").value = "";   // removes old filename from fn_input
