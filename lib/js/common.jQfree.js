...
xx.module("common", function (apod) {
  ...
  var msgcallback1 = null;
  var msgcallback2 = null;
 ...
 */
  ...
  function fixElementAndMask(ele_id, mask_id, mustdoit) {
    ...
    let t =
      (window.outerHeight - q.getHeight(bx) - 100) / 2 +
      document.body.scrollTop;
    // let l = (window.outerWidth - q.getWidth(bx)) / 2 + document.body.scrollLeft;
    t = t - 10;
    if (t < 10) t = 10;
    // if (l < 10) l = 10;
 ...
 */
  ...
  function centreBoxAndShow(b) {
    ...
    let t =
      (window.innerHeight - q.offsetHeight(b)) / 2.7 + document.body.scrollTop;
    let l =
      (window.innerWidth - q.offsetWidth(b)) / 2 + document.body.scrollLeft;
  ...
  // q.delegate("topdiv", "click", "#theMenu li", function __clickOnAMenuItem(e) {
  q.delegate("topmenucontainer", "click", "#theMenu li", function __clickOnAMenuItem(e) {
    ...
    // q._("tdhead").classList.add("nodisplay");
    callMenuFunc();
  }
  );
  ...
  let tm_disable = function () { };
  let tm_enable = function () { };
  let gc_disable = function () { };
  let gc_enable = function () { };

  function transfer_needed_variables(ob) {
    tbh = ob.tbh;
    lastBw = ob.lastBw;
    putTopdiv = ob.putTopdiv;
    tm_disable = ob.tm_disable;
    tm_enable = ob.tm_enable;
    gc_disable = ob.gc_disable;
    gc_enable = ob.gc_enable;
  }
